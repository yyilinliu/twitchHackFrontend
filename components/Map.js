  ...
  render() {
    ...
    return (
      <View style={{
        ...
        <ImageBackground source={OG_IMG} style={{opacity:0.75,width:400,height:105, alignItems:'center', justifyContent:'flex-end', marginTop:0, paddingBottom:5}}>
          {/* <Header
      ...
      <View style={{flex:0.26}}></View>
            <Text style={{fontFamily: 'Arial', fontSize:28, fontWeight:'bold', color:'red'}}>
