...
let exportForAppHosting = exports.exportForAppHosting = (() => {
  var _ref11 = _asyncToGenerator(function* (projectRoot, publicUrl, outputDir, options = {}) {
    yield _validatePackagerReadyAsync(projectRoot);

    // make output dir if not exists
    const pathToWrite = _path.default.resolve(projectRoot, _path.default.join(outputDir, 'assets'));
    yield (_fsExtra || _load_fsExtra()).default.ensureDir(pathToWrite);

    // build the bundles
    let { iosBundle, androidBundle } = yield _buildPublishBundlesAsync(projectRoot);
    yield _writeArtifactSafelyAsync(projectRoot, null, _path.default.join(outputDir, 'ios.js'), iosBundle);
    yield _writeArtifactSafelyAsync(projectRoot, null, _path.default.join(outputDir, 'android.js'), androidBundle);
    ...
    yield _fetchAndSaveAssetsAsync(projectRoot, exp, publicUrl, outputDir);
    ...
    exp.bundleUrl = (0, (_urlJoin || _load_urlJoin()).default)(publicUrl, 'android.js');
    ...
    yield _writeArtifactSafelyAsync(projectRoot, null, _path.default.join(outputDir, 'android-index.exp'), JSON.stringify(exp));

    // save the ios manifest
    exp.bundleUrl = (0, (_urlJoin || _load_urlJoin()).default)(publicUrl, 'ios.js');
    yield _writeArtifactSafelyAsync(projectRoot, null, _path.default.join(outputDir, 'ios-index.exp'), JSON.stringify(exp));
  });

  return function exportForAppHosting(_x18, _x19, _x20) {
    return _ref11.apply(this, arguments);
  };
})();

let _saveAssetAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectRoot, assets, outputDir) {
  ...
  return function _saveAssetAsync(_x21, _x22, _x23) {
...
let publishAsync = exports.publishAsync = (() => {
  ...
  return function publishAsync(_x24) {
    return _ref13.apply(this, arguments);
  };
})();

let _uploadArtifactsAsync = (() => {
  var _ref14 = _asyncToGenerator(function* ({ exp, iosBundle, androidBundle, options }) {
  ...
  return function _uploadArtifactsAsync(_x25) {
...
let _validatePackagerReadyAsync = (() => {
  ...
  return function _validatePackagerReadyAsync(_x26) {
...
let _getPublishExpConfigAsync = (() => {
  ...
  return function _getPublishExpConfigAsync(_x27, _x28) {
...
let _buildPublishBundlesAsync = (() => {
  ...
  return function _buildPublishBundlesAsync(_x29) {
...
let _maybeBuildSourceMapsAsync = (() => {
  var _ref18 = _asyncToGenerator(function* (projectRoot, exp, options = {}) {
    if (!options.force) {
  ...
  return function _maybeBuildSourceMapsAsync(_x30, _x31) {
...
let _collectAssets = (() => {
  var _ref19 = _asyncToGenerator(function* (projectRoot, exp, hostedAssetPrefix) {
    let entryPoint = yield (_Exp || _load_Exp()).determineEntryPointAsync(projectRoot);
    ...
    yield _resolveManifestAssets(projectRoot, exp, (() => {
      var _ref20 = _asyncToGenerator(function* (assetPath) {
  ...
  return function _collectAssets(_x32, _x33, _x34) {
...
let _configureExpForAssets = (() => {
  var _ref21 = _asyncToGenerator(function* (projectRoot, exp, assets) {
  ...
  return function _configureExpForAssets(_x36, _x37, _x38) {
    return _ref21.apply(this, arguments);
  };
})();

let _fetchAndUploadAssetsAsync = (() => {
  var _ref22 = _asyncToGenerator(function* (projectRoot, exp) {
  ...
  return function _fetchAndUploadAssetsAsync(_x39, _x40) {
    return _ref22.apply(this, arguments);
  };
})();

let _fetchAndSaveAssetsAsync = (() => {
  var _ref23 = _asyncToGenerator(function* (projectRoot, exp, hostedUrl, outputDir) {
    (_Logger || _load_Logger()).default.global.info('Analyzing assets');
  ...
  return function _fetchAndSaveAssetsAsync(_x41, _x42, _x43, _x44) {
    return _ref23.apply(this, arguments);
  };
})();

let _writeArtifactSafelyAsync = (() => {
  var _ref24 = _asyncToGenerator(function* (projectRoot, keyName, artifactPath, artifact) {
  ...
  return function _writeArtifactSafelyAsync(_x45, _x46, _x47, _x48) {
...
let _maybeWriteArtifactsToDiskAsync = (() => {
  ...
  return function _maybeWriteArtifactsToDiskAsync(_x49) {
    return _ref25.apply(this, arguments);
  };
})();

let _handleKernelPublishedAsync = (() => {
  var _ref26 = _asyncToGenerator(function* ({ projectRoot, user, exp, url }) {
  ...
  return function _handleKernelPublishedAsync(_x50) {
...
let uploadAssetsAsync = (() => {
  var _ref27 = _asyncToGenerator(function* (projectRoot, assets) {
    // Collect paths by key, also effectively handles duplicates in the array
    const paths = {};
    assets.forEach(function (asset) {
      asset.files.forEach(function (path, index) {
    ...
    yield Promise.all((_lodash || _load_lodash()).default.chunk(missing, 5).map((() => {
      var _ref28 = _asyncToGenerator(function* (keys) {
        let formData = new (_FormData || _load_FormData()).default();
        for (const key of keys) {
          (_ProjectUtils || _load_ProjectUtils()).logDebug(projectRoot, 'expo', `uploading ${paths[key]}`);
  ...
  return function uploadAssetsAsync(_x51, _x52) {
    return _ref27.apply(this, arguments);
  };
})();

let _readFileForUpload = (() => {
  var _ref29 = _asyncToGenerator(function* (path) {
  ...
  return function _readFileForUpload(_x54) {
    return _ref29.apply(this, arguments);
  };
})();

let buildAsync = exports.buildAsync = (() => {
  var _ref30 = _asyncToGenerator(function* (projectRoot, options = {}) {
  ...
  return function buildAsync(_x55) {
    return _ref30.apply(this, arguments);
  };
})();

let _waitForRunningAsync = (() => {
  var _ref31 = _asyncToGenerator(function* (url) {
    try {
  ...
  return function _waitForRunningAsync(_x56) {
    return _ref31.apply(this, arguments);
  };
})();

let startReactNativeServerAsync = exports.startReactNativeServerAsync = (() => {
  var _ref32 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
    ...
    let exitPromise = new Promise(function (resolve, reject) {
      packagerProcess.once('exit', (() => {
        var _ref33 = _asyncToGenerator(function* (code) {
  ...
  return function startReactNativeServerAsync(_x57) {
...
let stopReactNativeServerAsync = exports.stopReactNativeServerAsync = (() => {
  var _ref34 = _asyncToGenerator(function* (projectRoot) {
    _assertValidProjectRoot(projectRoot);
    let packagerInfo = yield (_ProjectSettings || _load_ProjectSettings()).readPackagerInfoAsync(projectRoot);
  ...
  return function stopReactNativeServerAsync(_x59) {
...
let startExpoServerAsync = exports.startExpoServerAsync = (() => {
  var _ref35 = _asyncToGenerator(function* (projectRoot) {
    ...
    let manifestHandler = (() => {
      var _ref36 = _asyncToGenerator(function* (req, res) {
        try {
          ...
          yield _resolveManifestAssets(projectRoot, manifest, (() => {
            var _ref37 = _asyncToGenerator(function* (path) {
          ...
          let currentUser = yield (_User || _load_User()).default.getCurrentUserAsync();
          if (!currentUser) {
      ...
      return function manifestHandler(_x61, _x62) {
    ...
    app.post('/shutdown', (() => {
      var _ref39 = _asyncToGenerator(function* (req, res) {
        server.close();
        res.send('Success');
      });
  ...
  return function startExpoServerAsync(_x60) {
...
let stopExpoServerAsync = exports.stopExpoServerAsync = (() => {
  ...
  return function stopExpoServerAsync(_x68) {
    return _ref40.apply(this, arguments);
  };
})();

let _connectToNgrokAsync = (() => {
  var _ref41 = _asyncToGenerator(function* (projectRoot, args, hostnameAsync, ngrokPid, attempts = 0) {
    try {
  ...
  return function _connectToNgrokAsync(_x69, _x70, _x71, _x72) {
...
let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  ...
  return function startTunnelsAsync(_x73) {
...
let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  ...
  return function stopTunnelsAsync(_x74) {
    return _ref47.apply(this, arguments);
  };
})();

let setOptionsAsync = exports.setOptionsAsync = (() => {
  var _ref48 = _asyncToGenerator(function* (projectRoot, options) {
  ...
  return function setOptionsAsync(_x75, _x76) {
    return _ref48.apply(this, arguments);
  };
})();

let getUrlAsync = exports.getUrlAsync = (() => {
  var _ref49 = _asyncToGenerator(function* (projectRoot, options = {}) {
    _assertValidProjectRoot(projectRoot);
    return yield (_UrlUtils || _load_UrlUtils()).constructManifestUrlAsync(projectRoot, options);
  });

  return function getUrlAsync(_x77) {
    return _ref49.apply(this, arguments);
  };
})();

let startAsync = exports.startAsync = (() => {
  var _ref50 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
  ...
  return function startAsync(_x78) {
...
let _stopInternalAsync = (() => {
  ...
  return function _stopInternalAsync(_x79) {
    return _ref51.apply(this, arguments);
  };
})();

let stopAsync = exports.stopAsync = (() => {
  var _ref52 = _asyncToGenerator(function* (projectDir) {
  ...
  return function stopAsync(_x80) {
