...
let _createStandaloneContextAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (args) {
    ...
    const context = (_StandaloneContext || _load_StandaloneContext()).default.createServiceContext(expoSourcePath, args.archivePath, manifest, privateConfig, args.testEnvironment, buildFlags, args.url, args.releaseChannel);
    return context;
  });
