...
// versioned modules
{ podName: 'EXGL', libName: 'expo-gl' }, { podName: 'EXCore', libName: 'expo-core' }, { podName: 'EXCamera', libName: 'expo-camera' }, { podName: 'EXSensors', libName: 'expo-sensors' }, { podName: 'EXConstants', libName: 'expo-constants' }, { podName: 'EXFileSystem', libName: 'expo-file-system' }, { podName: 'EXPermissions', libName: 'expo-permissions' }, { podName: 'EXCameraInterface', libName: 'expo-camera-interface' }, { podName: 'EXSensorsInterface', libName: 'expo-sensors-interface' }, { podName: 'EXConstantsInterface', libName: 'expo-constants-interface' }, { podName: 'EXReactNativeAdapter', libName: 'expo-react-native-adapter' }, { podName: 'EXFileSystemInterface', libName: 'expo-file-system-interface' }, { podName: 'EXPermissionsInterface', libName: 'expo-permissions-interface' }, { podName: 'EXFaceDetectorInterface', libName: 'expo-face-detector-interface' }, { podName: 'EXSMS', libName: 'expo-sms' }, {
...
const expoSdkUniversalModulesConfigs = expoSdkUniversalModules.map((_ref) => {
  let { config, podName, libName, isNativeModule } = _ref,
      params = _objectWithoutProperties(_ref, ['config', 'podName', 'libName', 'isNativeModule']);
